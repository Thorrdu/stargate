                ...
                'fields' => [
                    [
                        ...
                        'value' => trans('generic.general',[],$this->player->lang).": ".number_format($this->player->points_total)." Points ".$this->getIndicator('points_total')." (Position: ".number_format($generalPosition)."/{$totalPlayers})\n"
                                  ...
                                  .config('stargate.emotes.research')." ".trans('generic.research',[],$this->player->lang).": ".number_format($this->player->points_research)." Points ".$this->getIndicator('points_research')." (Position: ".number_format($researchPosition)."/{$totalPlayers})\n"
