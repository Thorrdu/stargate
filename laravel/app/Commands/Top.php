        ...
        if(!is_null($this->player))
        {
            ...
            try{
                ...
                if(Str::startsWith('general', $this->args[0])){
                    ...
                    $this->playerList = Player::all()->where('npc', 0)->sortByDesc('points_total'); 
                }     
                elseif(Str::startsWith('building', $this->args[0])){
                    $this->topType = 'building';
                    $this->playerList = Player::all()->where('npc', 0)->sortByDesc('points_building');
                }      
                elseif(Str::startsWith('research', $this->args[0])){
                    $this->topType = 'research';
                    $this->playerList = Player::all()->where('npc', 0)->sortByDesc('points_research');   
                }  
