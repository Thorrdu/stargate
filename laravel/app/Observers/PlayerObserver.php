                ...
                if(is_null($player->active_technology_id) && $player->isDirty('active_technology_id'))
                {
                    ...
                    {               
                        ...
                        if($hasRequirements)
                        {
                            ...
                            $reminder->reminder = trans('generic.buildingUnlocked', ['name' => $building->name], $player->lang);
                    ...
                    foreach($technologies as $technology)
                    {
                        ...
                        if($hasRequirements)
                        {
                            $reminder = new Reminder;
                            $reminder->reminder_date = Carbon::now();
                            $reminder->reminder = trans('generic.researchUnlocked', ['name' => $technology->name], $player->lang);
                            $reminder->player_id = $player->id;
                            $reminder->save();
                        }
                    }
