...
return [
    ...
    'incomingFleet' => '[**:mission**] Une flotte étrangère de **:shipCount :shipType** en provenance de **:colonySource [:coordinatesSource]** se dirige vers **:colonyDest [:coordinatesDest]**',
