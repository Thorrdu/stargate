...
return [
    ...
    'allianceCreated' => "L'alliance [**:tag**] **:allianceName** a été créée.",
    'allianceDisbanded' => "L'alliance **:allianceName** a été dissoute.",
    ...
    'roleNameChanged' => "Le rôle **:oldRole** a été modifié en **:newRole**.",
    ...
    'memberKicked' => "**:name** a été **kick** hors de **:allianceName**.",
    ...
    'alreadyBottomRank' => 'Ce joueur est déjà au rang le plus bas.',
    'onlyOneLeader' => 'Il ne peut y avoir qu\'un leader.'
];
