...
return [
    ...
    'incomingFleets' => "__Incoming fleets__\n:fleets",
    'noActiveFleet' => 'No active fleet',
    'noIncomingFleet' => 'No incoming fleet',
    'returningStatus' => 'Returning',
    'ongoingStatus' => 'Ongoing',
    'activeFleet' => '[**:mission/:status**] [ID:**:id**] Your fleet of **:shipCount :shipType** coming from **:colonySource [:coordinatesSource]** is heading towards **:colonyDest [:coordinatesDest]**',
    'incomingFleet' => '[**:mission**] A fleet of **:shipCount :shipType** coming from **:colonySource [:coordinatesSource]** is heading towards **:colonyDest [:coordinatesDest]**',
